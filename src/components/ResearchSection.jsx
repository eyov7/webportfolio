    ...
    <section id="ai-ml" className="box">
      ...
      <Accordion type="single" collapsible defaultValue="item-1">
        <AccordionItem value="item-1">
          <AccordionTrigger className="text-lg font-bold text-black">Video Presentation</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger className="text-lg font-bold text-black">Literature Review Slides</AccordionTrigger>
          <AccordionContent>
            <div className="p-4 bg-white/10 rounded-lg">
              <iframe
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger className="text-lg font-bold text-black">Additional Research Presentation 1</AccordionTrigger>
          <AccordionContent>
            <div className="p-4 bg-white/10 rounded-lg">
              <iframe
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger className="text-lg font-bold text-black">Additional Research Presentation 2</AccordionTrigger>
          <AccordionContent>
            <div className="p-4 bg-white/10 rounded-lg">
              <iframe
